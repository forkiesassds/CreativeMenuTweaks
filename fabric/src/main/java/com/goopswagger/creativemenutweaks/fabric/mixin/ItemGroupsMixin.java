...
public class ItemGroupsMixin {
    ...
    //  we have to do this ugly mess, where we target the unmapped name rather than the one that our mappings expect.
    @SuppressWarnings({"UnresolvedMixinReference", "InvalidInjectorMethodSignature", "MixinAnnotationTarget"})
    @WrapOperation(method = "method_51316", at = @At(value = "INVOKE", target = "Lnet/minecraft/class_2378;iterator()Ljava/util/Iterator;", remap = false))
